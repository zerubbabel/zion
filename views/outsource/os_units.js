var grid_data=[];
var detail_data=[];
var edit_url="views/outsource/data/os_units_edit.php";
var caption='加工单位列表';
function get_os_types(){
	//return "FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX";
	var str="";
	var para={'method':'getOsTypes'};
...
jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		colModel:[
			...
			{name:'type_name',index:'type_name', width:90, sortable:true,editable: true,edittype:'select',editoptions:{value:get_os_types()}} 
		], 
