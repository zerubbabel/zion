var grid_data=[];
var detail_data=[];
function get_cust_types(){
	//return "FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX";
	//动态生成select内容
	var str="";
	var para={'method':'getCustTypes'};
...
jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		colModel:[
			...
			{name:'supplier_name',index:'supplier_name', width:90,editable: true,},		
			{name:'type_name',index:'type_name', width:90, sortable:true,editable: true,edittype:'select',editoptions:{value:get_cust_types()}} 
		], 
		...
		editurl: "views/purchase/data/suppliers_edit.php",
		caption: "供应商列表",
		autowidth: true,
	});
