...
function loadDetail(loc_id){	
	...
	jQuery("#tbl_dtl").jqGrid({
		...
		colModel:[					
			{name:'product_id',index:'product_id', width:50, sortable:true,editable: false},
			{name:'name',index:'name', width:110, sortable:true,editable: false},
			{name:'gg',index:'gg', width:110, sortable:true,editable: false},
			{name:'qty',index:'qty', width:40, sortable:false,editable: true},
			...
			{name:'bin',index:'bin', width:50, sortable:false,editable: true},
