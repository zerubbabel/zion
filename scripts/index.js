...
var indexApp=angular.module('indexApp', ['ngRoute'])
  .config(function($routeProvider) {
    ...
    $routeProvider
    .when('/views/sale/customer_orders_manage', {
      templateUrl: 'views/sale/customer_orders_manage.php',
      resolve: {
        async: ['$q', '$location', auth]
      }
    })
    .when('/views/sale/customer_orders', {
      templateUrl: 'views/sale/customer_orders.php',
      resolve: {
        async: ['$q', '$location', auth]
      }
    })
    ...
    .when('/views/work/tasks', {
      templateUrl: 'views/work/tasks.php',
      resolve: {
        async: ['$q', '$location', auth]
      }
    })
    ...
    .when('/views/work/new_wc_work_draw', {
      templateUrl: 'views/work/new_wc_work_draw.php',
      resolve: {
        async: ['$q', '$location', auth]
      }
    })
    ...
    .when('/views/stock/stock_bin_init', {
      templateUrl: 'views/stock/stock_bin_init.php',
      resolve: {
        async: ['$q', '$location', auth]
      }
    })
    .when('/views/stock/stock_bin', {
      templateUrl: 'views/stock/stock_bin.php',
      resolve: {
        async: ['$q', '$location', auth]
      }
    })
