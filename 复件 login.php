...
if(!isset($_SESSION['user_id'])){
    if(isset($_POST['submit'])){//用户提交登录表单时执行如下代码
        ...
        $user_username =trim($_POST['username']); //mysqli_real_escape_string($dbc,trim($_POST['username']));
        $user_password =trim($_POST['password']); //mysqli_real_escape_string($dbc,trim($_POST['password']));
